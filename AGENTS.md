...
- **Styling & UI**: Tailwind combined with Ant Design. Do not use raw CSS where Tailwind standard classes can be applied. Realize that blog posts display markdown parsed through `marked` and sanitized with `DOMPurify`.
